    ...
    className="bg-[#E0F0F2] rounded h-full w-full overflow-y-auto text-blue-950 font-DotGothic">
      ...
      ring-1 ring-white/25  backdrop-blur-[65px] border  border-white/50 shadow-2xl overflow-y-auto lg:overflow-hidden h-[440vh]
       ...
       <div className="lg:w-[40%] w-full h-[800px] lg:h-full  lg:static z-5 flex flex-col bg-zinc-100/70   rounded lg:rounded-r-none items-center   ">
          <div className=" h-[60%] p-2 "><img className="rounded h-[90%]" src={AiInfra1} alt="" /><h1 className="text-3xl text-blue-950 my-4 font-DotGothic font-bold">AI Infrastructure Engineer</h1>
            <hr />
          </div>
